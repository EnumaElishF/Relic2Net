...
public class PlayerServerController : MonoBehaviour, IPlayerServerController,IStateMachineOwner
{
    ...
    public void OnNetworkSpawn()
    {
        ...
        AOIUtility.AddPlayer(mainController, currentAOICoord);
    ...
    public void OnNetworkDespawn()
    {
        ...
        AOIUtility.RemovePlayer(mainController, currentAOICoord);
    }
    ...
    public void UpdateAOICoord()
    {
        ...
        {
            AOIUtility.UpdatePlayerCoord(mainController, currentAOICoord, newCoord);
